...
/* La funcion Lectura se utiliza para leer un arreglo unidimencional de T elemetos de tipo entero. */
{
    int I;
    for (I=0; I<T; I++)
    {
...
/* Esta funcion localiza enj el arreglo un elemento determinado. Si el elemento es encontrado, regresa la posicion correspondiente. en caso contrario, regresa 0. */
{
    int I = 0, BAN = 0, RES;
    while (I < T && !BAN)
        BAN++;
