...
void main(void)
{
    ...
    *IX = 1; /* Z[2] se modifica, ahora vale 1. */
    ...
    *IX = 15; /* Z[2] se modifica, ahora vale 15. */
    printf("\nX = %d \t Y = %d \t Z[0] = %d \t Z[1] = [1] = %d \t Z[2] = %d \t Z[3] = %d \t Z[4] = %d", X, Y, Z[0], Z[1], Z[2], Z[3], Z[4]);
    X = *IX + 5; /* X se modifica, ahora vale Z[2] + 5 = 20. Recuerda que *IX contiene el valor de Z[2]. */
    *IX = *IX - 5; /* Z[2] se modifica, ahora vale 10. */
    printf("\nX = %d \t Y = %d \t Z[0] = %dt Z[1] = %d \t Z[2] = %d \t Z[3] = %d \t Z[4] = %d", X, Y, Z[0], Z[1], Z[2], Z[3], Z[4]);
    ++*IX; /* Z[2] se modifica, se incrementa en el 1. Z[2] ahora vale 11. */
    *IX += 1; /* Z[2] se vuelve a modificar, ahora vale 12. */
    ...
    Y = *(IX + 1); /* Y se modifica, toma el valor de Z[2] (12). */
    printf("\nX = %d \t Y = %d \t Z[0] = %d \t Z[1] = %d \t Z[2] = %d \t Z[3] = %d \t Z[4] = %d", X, Y, Z[0], Z[1], Z[2], Z[3], Z[4]);
