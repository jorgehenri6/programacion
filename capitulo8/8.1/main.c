...
/* Estructura-1.
El programa muestra la manera en que se declara una estrutura, asi como la forma en que se tiene acceso a los campos de las variables de tipo estructura tanto para asignacion de valores como para lectura y escritura. */

struct alumno                     /* Declaracion de la estrutura. */
{
    int matricula;
    char nombre[20];
...
void main(void)
{
    /* Observa que las variables de tipo estructura se declaran como calquier otra variable. a1, a2 y a3 son variables de tipo estructura alumno. */
    ...
    a3.promedio = pro;
    fflush(stdin);
    printf("Ingrese la dirrecion del alumno 3: ");
    gets(dir);
    printf(a3.direccion, dir);
    ...
    printf("\nDatos del alumno 3\n");
    printf("%d \t %s \t %s \t 5.2f \t %s", a3.matricula, a3.nombre, a3.promedio, a3.direccion);
}
