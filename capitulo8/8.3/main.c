...
/* Estructuras-3.
El programa muestra la manera en que se declara una estructura anidada, asi como la forma de acceso a los campos de las variables o apuntadores de tipo estructura. Se utiliza ademas una funcion que recibe como parametro un apuntador de tipo estructura. */
...
/* Funcion que permite leer los campos de un apuntador de tipo esctructura empleado. */
{
    ...
    gets(a->departamento);
    printf("Ingrese el suldo del empleado: ");
    scanf("%f", &a->sueldo);
    fflush(stdin);
...
void main(void)
{
    ...
    /* Se declaran diferentes variables y apuntadores de la estructura empeado para que el lector pueda apreciar tambien las diferentes formas en que los campos reciben valores. */
