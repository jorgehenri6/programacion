...
/* Universidad.
El programa, al recibir informacion sobre el numero de alumnos que han ingresado a sus ocho diferentrs carreras en los dos semetres lectivos de los ultimos cinco años, obtiene informacion util para el departamento de escolar. */
...
/* Esta funcion se utiliza para determinar el año en el que ingreso el mayor numero de alumnos a la universidad. Observa que el primer ciclo externo corresponde a los años. */
{
    ...
    for (K=0; K<PR; K++)
    /* por cada año se suma el imgreso de los dos semestres de las ocho carreras. */
    {
        SUM = 0;
        for (I=0; I<FI; I++)
            for (J=0; J<CO; J++)
...
/* Esta funcion se utiliza para determinar la carrera que recibio el amyor numero de alumnos el ultimo año. Observa que no se utiliza un ciclo para los planos de la profundida, ya que es un dato (PR). */
{
