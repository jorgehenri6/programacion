...
/* Intercambia.
El programa intercambia con las columnas de un arreglo bidimencional. Los elementos de la primera se intercambian con los de la ultima, los de la segunda con los de la penultima, asi sucesivamente. */
...
/* Esta funcion se utiliza para intercambiar las columnas del arreglo bidimencional. Observa que el indice correspondiente a las columnas solo se mueve hasta la mitad del arreglo. */
{
    int I, J;
    float AUX;
