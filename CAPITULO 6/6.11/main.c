...
/* Casa de bolsa.
El progrmam, al recibir como datos los precios mensuales de las acciones de sus cinco fondos de inversion, ademas del precio de las acciones al 31 de diciembre del 2003, genera informacion estadistica para la empresa. */
...
void main(void)
{
    ...
    /* REN es un arreglo unidimensional de tipo real que se utilizara para almacenar el arendimiento anual de los fondos de inversion. */
...
/* Esta funcion se utiliza para leer un arreglo unidimensional de tipo real de T elemetos. */
{
    int I;
    printf("\n");
    for (I=0; I<T; I++)
...
{
    /* La funcion F1 se utliza para calcular el rendimiento anual de los fondos de inversion. El resultado se almacena en el arreglo unidimensional V. */
    int I;
    printf("\nRENDIMIENTOS ANUALES DE LOS FONDOS");
    for (I=0; I<F; I++)
    {
        V[1] = (A[I][C-1] - B[I]) / B[I] * 100;
        printf("\nFondo %d:  %.2f", I+1, V[I]);
    }
}
